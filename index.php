...
$ProdC=new ProdC();
$listeprods=$ProdC->afficheroffer();
...
<body>
  ...
  ― Kobe Bryant.
        ...
        <!-- <div class="Cart"><img src="images/Cart.svg" alt=""></div> -->
        <div class="box">
        <div class="scrollcontainer"><div class="scrolldown">By Oussema</div></div>
...
if($user)
{
  ...
  ?>
      ...
      <div id="home"class="text">
        <div class="title">AND1</div>
        <p>“At the end of the day, the goals are simple:  <br> Safety and security."</p>
      </div>
  
      <div class="watchnow">
        <i class="fa fa-play"></i>
        <a href="https://www.youtube.com/watch?v=CMWuG3wcWO8">watch now!</a>
      </div>
      ...
      <div class="ellipse-container" style=" background: url('images/NBA.jpg');background-size: cover;">
  ...
  <br>
  <br>
  <h1 id="Offers"class="section-title">Offers</h1>
  <div class="Offers">
  <?php 
          ...
          <div class="product-front">
              ...
              <div class="product-bottom">
                ...
                <br>
                  ...
                  <input type="hidden"name="product_id"value="<?php echo $prods['id']; ?>">
                  </form>  
                    ...
                    <form action=""method="POST">
                      <div class="customization">
                        ...
                        <input type="hidden"name="product_id"value="<?php echo $prods['id']; ?>">
                          ...
                          <div class="select-item">
                              <img src="<?php echo $prods['backimg']; ?>" alt="">
                          </div>
                      </div>
                      </div>
                      </form>
